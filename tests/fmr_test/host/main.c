...
int main(int argc, char *argv[]) {
    ...
    printf("[client] Connected to device '%s'.\n", device->name);
        ...
        // Function 0: my_lf_int8_argument_test
        ...
        expected = 0;
        result = lf_invoke_by_index(device, module_name, 0, lf_int8_t, &ret_value, args);
        ...
        // Function 1: my_lf_int16_argument_test
        ...
        expected = 0;
        result = lf_invoke_by_index(device, module_name, 1, lf_int16_t, &ret_value, args);
        if (result == lf_success) {
        ...
        // Function 2: my_lf_int32_argument_test
        printf("[client] Sending RPC packet to invoke '%s' function 2\n", module_name);
        args = NULL;
        uint32_t arg2_val = 1;
        struct _lf_arg *arg2 = lf_arg_create(lf_uint32_t, (lf_arg)arg2_val); // Use lf_uint32_t (19)
        ...
        // Function 4: my_lf_ptr32_argument_test
        printf("[client] Sending RPC packet to invoke '%s' function 4\n", module_name);
        args = NULL;
        uint32_t arg4_val = 2;
        struct _lf_arg *arg4 = lf_arg_create(lf_uint32_t, (lf_arg)arg4_val); // Use lf_uint32_t (19)
        if (!arg4 || lf_ll_append(&args, arg4, free) != lf_success) {
            fprintf(stderr, "[client] Failed to create or append arg for function 4\n");
            lf_ll_release(&args);
            goto cleanup;
        }
        expected = 0;
        result = lf_invoke_by_index(device, module_name, 4, lf_int32_t, &ret_value, args);
        if (result == lf_success) {
        ...
        // Function 7: my_lf_int8_result_test
        printf("[client] Sending RPC packet to invoke '%s' function 7\n", module_name);
        args = NULL;
        uint8_t arg7_val = 16;
        struct _lf_arg *arg7 = lf_arg_create(lf_uint8_t, (lf_arg)arg7_val); // Use lf_uint8_t (16)
        ...
        result = lf_invoke_by_index(device, module_name, 7, lf_int8_t, &ret_value, args);
        if (result == lf_success) {
        ...
        // Function 8: my_lf_int16_result_test
        printf("[client] Sending RPC packet to invoke '%s' function 8\n", module_name);
        args = NULL;
        uint16_t arg8_val = 4931;
        struct _lf_arg *arg8 = lf_arg_create(lf_uint16_t, (lf_arg)arg8_val); // Use lf_uint16_t (17)
        if (!arg8 || lf_ll_append(&args, arg8, free) != lf_success) {
            fprintf(stderr, "[client] Failed to create or append arg for function 8\n");
            lf_ll_release(&args);
            goto cleanup;
        }
        expected = (int64_t)(arg8_val * 2);
        result = lf_invoke_by_index(device, module_name, 8, lf_int16_t, &ret_value, args);
        if (result == lf_success) {
        ...
        // Function 9: my_lf_int32_result_test
        printf("[client] Sending RPC packet to invoke '%s' function 9\n", module_name);
        args = NULL;
        uint32_t arg9_val = 1;
        struct _lf_arg *arg9 = lf_arg_create(lf_uint32_t, (lf_arg)arg9_val); // Use lf_uint32_t (19)
        ...
        result = lf_invoke_by_index(device, module_name, 9, lf_int32_t, &ret_value, args);
        if (result == lf_success) {
        ...
        // Function 10: my_lf_int_result_test
        printf("[client] Sending RPC packet to invoke '%s' function 10\n", module_name);
        args = NULL;
        int arg10_val = 111;
        struct _lf_arg *arg10 = lf_arg_create(lf_int_t, (lf_arg)arg10_val); // Use lf_int_t (4)
        if (!arg10 || lf_ll_append(&args, arg10, free) != lf_success) {
            fprintf(stderr, "[client] Failed to create or append arg for function 10\n");
            lf_ll_release(&args);
            goto cleanup;
        }
        expected = (int64_t)(arg10_val * 2);
        result = lf_invoke_by_index(device, module_name, 10, lf_int_t, &ret_value, args);
        if (result == lf_success) {
        ...
        // Function 11: my_lf_ptr32_result_test
        printf("[client] Sending RPC packet to invoke '%s' function 11\n", module_name);
        args = NULL;
        uint32_t arg11_val = 0;
        struct _lf_arg *arg11 = lf_arg_create(lf_uint32_t, (lf_arg)arg11_val); // Use lf_uint32_t (19)
        ...
        result = lf_invoke_by_index(device, module_name, 11, lf_uint32_t, &ret_value, args);
        if (result == lf_success) {
        ...
        // Function 12: my_lf_ptr64_result_test
        printf("[client] Sending RPC packet to invoke '%s' function 12\n", module_name);
        args = NULL;
        uint64_t arg12_val = 2;
        struct _lf_arg *arg12 = lf_arg_create(lf_uint64_t, (lf_arg)arg12_val); // Use lf_uint64_t (3)
        if (!arg12 || lf_ll_append(&args, arg12, free) != lf_success) {
            fprintf(stderr, "[client] Failed to create or append arg for function 12\n");
            lf_ll_release(&args);
            goto cleanup;
        }
        expected = (int64_t)(arg12_val * 2);
        result = lf_invoke_by_index(device, module_name, 12, lf_uint64_t, &ret_value, args);
        if (result == lf_success) {
        ...
        // Function 13: my_lf_int64_result_test
        printf("[client] Sending RPC packet to invoke '%s' function 13\n", module_name);
        args = NULL;
        uint64_t arg13_val = 0;
        struct _lf_arg *arg13 = lf_arg_create(lf_uint64_t, (lf_arg)arg13_val); // Use lf_uint64_t (3)
        if (!arg13 || lf_ll_append(&args, arg13, free) != lf_success) {
            fprintf(stderr, "[client] Failed to create or append arg for function 13\n");
            lf_ll_release(&args);
            goto cleanup;
        }
        expected = (int64_t)((int64_t)arg13_val * 2);
        result = lf_invoke_by_index(device, module_name, 13, lf_int64_t, &ret_value, args);
        if (result == lf_success) {
