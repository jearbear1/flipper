...
INC_DIRS = platforms/atmegau2/include \
			os/include \
			lib \
			/opt/homebrew/Cellar/avr-gcc@11/11.3.0_1/avr/include 
...
LDFLAGS = -mavr35 \
			-Tdata 0x800100 \
			-L/opt/homebrew/Cellar/avr-gcc@11/11.3.0_1/avr/lib/avr35 \
			-lc \
			-lm \
			/opt/homebrew/Cellar/avr-gcc@11/11.3.0_1/avr/lib/avr35/crtatmega32u2.o \
			-L/opt/homebrew/Cellar/avr-gcc@11/11.3.0_1/lib/avr-gcc/11/gcc/avr/11.3.0/avr35 \
			-lgcc \
			--gc-sections
